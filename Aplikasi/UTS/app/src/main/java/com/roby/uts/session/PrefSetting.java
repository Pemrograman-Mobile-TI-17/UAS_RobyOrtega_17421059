...
public void islogin(SessionManager session, SharedPreferences pref){
 ...
 public void checkLogin(SessionManager session, SharedPreferences pref){
  ...
  public void storeRegIdSharedPrefences(Context context, String id, String userName, String namaLengkap, String email, String noTelp, String role, SharedPreferences prefs) {
